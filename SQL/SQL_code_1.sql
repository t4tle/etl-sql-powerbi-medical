...
ADD CONSTRAINT clarity_loc_pk PRIMARY KEY (patient_id);
ALTER TABLE hsp_account
ADD CONSTRAINT hsp_account_pk PRIMARY KEY (HSP_ACCOUNT_ID);
ALTER TABLE or_log
...
ADD CONSTRAINT pat_enc_hsp_pk PRIMARY KEY (patient_id);
...
ADD CONSTRAINT res_components_pk PRIMARY KEY (RESULT_ID);
...
ADD CONSTRAINT v_lab_results_pk PRIMARY KEY (RESULT_ID);
